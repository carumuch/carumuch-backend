...
class AccountRecoveryServiceTest {
	...
	class RetrieveLoginIdRequest {
		...
		void 이메일에_해당하는_사용자가_있는지_확인한다() {
			...
			com.carumuch.capstone.auth.presentation.dto.request.RetrieveLoginIdRequest retrieveLoginIdRequest = new com.carumuch.capstone.auth.presentation.dto.request.RetrieveLoginIdRequest(user.getEmail());
