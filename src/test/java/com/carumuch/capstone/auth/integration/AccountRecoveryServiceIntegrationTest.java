package com.carumuch.capstone.auth.integration;
...
import com.carumuch.capstone.auth.application.AccountRecoveryService;
import com.carumuch.capstone.auth.application.VerificationCodeStore;
...
import com.carumuch.capstone.auth.presentation.dto.request.RetrievePasswordRequest;
import com.carumuch.capstone.auth.presentation.dto.request.ResetPasswordRequest;
import com.carumuch.capstone.auth.presentation.dto.request.VerifyPasswordCodeRequest;
import com.carumuch.capstone.auth.presentation.dto.response.VerifyPasswordCodeResponse;
...
public class AccountRecoveryServiceIntegrationTest extends IntegrationSupportTest {
	...
	class RetrieveLoginIdRequest {
		...
		void 아이디_찾기_이메일을_전송한다() {
			...
			com.carumuch.capstone.auth.presentation.dto.request.RetrieveLoginIdRequest retrieveLoginIdRequest = new com.carumuch.capstone.auth.presentation.dto.request.RetrieveLoginIdRequest(email);
