...
class AccountRecoveryServiceTest {
	...
	class RetrieveLoginIdRequest {
		...
		void 이메일에_해당하는_사용자가_있는지_확인한다() {
			...
			com.carumuch.capstone.identity.presentation.dto.request.auth.RetrieveLoginIdRequest retrieveLoginIdRequest = new com.carumuch.capstone.identity.presentation.dto.request.auth.RetrieveLoginIdRequest(user.getEmail());
