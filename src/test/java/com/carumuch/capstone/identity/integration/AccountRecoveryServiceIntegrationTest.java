...
import com.carumuch.capstone.identity.application.VerificationCodeStore;
...
public class AccountRecoveryServiceIntegrationTest extends IntegrationSupportTest {
	...
	class RetrieveLoginIdRequest {
		...
		void 아이디_찾기_이메일을_전송한다() {
			...
			com.carumuch.capstone.identity.presentation.dto.request.auth.RetrieveLoginIdRequest retrieveLoginIdRequest = new com.carumuch.capstone.identity.presentation.dto.request.auth.RetrieveLoginIdRequest(email);
